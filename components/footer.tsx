...
function footer() {
  return (
    <div>
      <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white">
  {/* <!-- Grid --> */}
    ...
    <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                ...
                <div className="flex flex-col  " >
                  ...
                  <p className="mt-3 text-xs sm:text-sm text-gray-600 ">© Rent now!</p>
                </div>
              </a>
            </div>
      <div>
        ...
        <div className="mt-3 grid space-y-3 text-sm">
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 " href="/pricing">Pricing</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 " href="/contact">Contact</a></p>
      ...
      <div>
        ...
        <div className="mt-3 grid space-y-3 text-sm">
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 " href="https://github.com/cjephuneh">Api</a></p>
          {/* <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 " href="#">Status</a></p> */}
      ...
      <div className="sm:flex sm:justify-between sm:items-center">
        ...
        <div className="flex justify-between items-center">
          <div className="mt-3 sm:hidden">
            <a className="flex-none text-xl font-semibold " href="#" aria-label="Brand">Soko Yetu</a>
            <p className="mt-1 text-xs sm:text-sm text-gray-600">© Rent now!.</p>
          </div>

          <div className="space-x-4">
            <a className="inline-block text-gray-500 hover:text-gray-800 " href="https://twitter.com/Code4jeph">
            ...
            <a className="inline-block text-gray-500 hover:text-gray-800" href="https://github.com/cjephuneh">
              <svg className="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
