    ...
    <div className="max-w-2xl lg:max-w-5xl mx-auto py-8">
        ...
        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid gap-4">
                ...
                <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" className="py-3 px-4 block w-full border rounded-lg text-sm  disabled:opacity-50 " placeholder="Details"></textarea>
                </div>
            </div>
