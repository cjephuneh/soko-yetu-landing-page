          ...
          <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="py-3 px-4 block w-full border text-black rounded-lg text-sm disabled:opacity-50 disabled:pointer-events-none "
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="py-3 px-4 block w-full border rounded-lg text-black text-sm disabled:opacity-50 disabled:pointer-events-none"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="py-3 px-4 block w-full border rounded-lg text-sm text-black  disabled:opacity-50 disabled:pointer-events-none"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="py-3 px-4 block w-full border rounded-lg  text-black text-sm  disabled:opacity-50 "
                    placeholder="Details"
              ...
              <div className="mt-4 grid">
                <button
                  type="submit"
                  className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2  font-semibold rounded-lg border text-black bg-blue-500 text-lg"
                >
                  Send inquiry
                </button>
              </div>
