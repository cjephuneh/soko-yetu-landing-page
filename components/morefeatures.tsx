      ...
      <section className="mx-auto px-6 text-gray-800 md:max-w-screen-xl">
        ...
        <div className="grid gap-10 pb-20 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="my-4 flex items-center">
                ...
                <h3 className="text-2xl font-bold md:text-xl">User-Friendly Interface</h3>
            </div>
            <p className="text-gray-700">Intuitive dashboard and navigation for easy store management.</p>
            </div>
            <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
                <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-lg border bg-blue-50 text-2xl text-blue-500">
                ...
                <h3 className="text-2xl font-bold md:text-xl">Customizable Templates (coming soon)</h3>
            </div>
            <p className="text-gray-700">A variety of pre-designed templates and themes for personalized storefronts.</p>
            </div>
            <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
                <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-lg border bg-blue-50 text-2xl text-blue-500">
                ...
                <h3 className="text-2xl font-bold md:text-xl">Product Management</h3>
            </div>
            <p className="text-gray-700">Ability to add, edit, and organize products with categories, descriptions, and images.</p>
            </div>
            <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
                <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-lg border bg-blue-50 text-2xl text-blue-500">
                ...
                <h3 className="text-2xl font-bold md:text-xl">Shipping & Tax Calculators</h3>
            </div>
            <p className="text-gray-700">Features to calculate shipping costs and taxes based on location and product specifications.</p>
            </div>
            <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
                <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-lg border bg-blue-50 text-2xl text-blue-500">
                ...
                <h3 className="text-2xl font-bold md:text-xl">Order Management</h3>
            </div>
            <p className="text-gray-700">Tools to track orders, manage fulfillment, and provide order status updates to customers.</p>
            </div>
            <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
                <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-lg border bg-blue-50 text-2xl text-blue-500">
                ...
                <h3 className="text-2xl font-bold md:text-xl">Multi-language & Currency Support</h3>
            </div>
            <p className="text-gray-700">Ability to cater to a global audience by supporting multiple languages and currencies.</p>
            </div>
        </div>
        </section>
    </div>
